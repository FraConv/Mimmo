...
<p className=" text-[white] text-[20px] mt-[-8px] md:text-[27px] xl:text-[32px] text-left">Qui potete trovare tutte le guide su tutto quello che riguarda Raspberry.</p>
</div>
