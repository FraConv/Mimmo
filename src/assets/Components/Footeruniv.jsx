...
<footer className=" w-[100%] h-24  left-0 absolute bg-[#1b4455]">
...
<a className=" text-white hover:text-[#f9b65d] text-[14px] ml-[-170px] pt-[60px] md:ml-[-510px] xl:ml-[-996px] min-[1400px]:ml-[-1506px]" href="https://www.iubenda.com/privacy-policy/13346282">Privacy Policy</a>
