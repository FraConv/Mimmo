...
<div className=" ml-[-65px] border-2 border-transparent w-[270px] h-[50px] xl:w-[650px] xl:h-[100px] mt-[32px] xl:ml-[-100px] xl:mt-[100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
...
<div className=" border-2 border-transparent w-[300px] h-[200px] xl:w-[650px] xl:h-[200px] mt-28 ml-[-65px] xl:ml-[-100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[300px]">
...
<div className=" border-2 border-transparent w-[300px] h-[120px] xl:w-[650px] xl:h-[130px] mt-5 ml-[-65px] xl:ml-[-100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[180px]">
...
<div className=" w-[300px] h-[50px] border-[4px] border-black bg-slate-700 mt-10 ml-[-65px] rounded-2xl xl:ml-[-100px] xl:mt-[120px] xl:w-[480px] xl:h-[50px] xl:rounded-[20px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
...
<div className=" border-2 border-transparent w-[300px] h-[520px] xl:w-[650px] xl:h-[520px] mt-16 ml-[-65px] xl:ml-[-100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[680px]">
...
<div className=" w-[300px] h-[185px] border-[4px] border-black bg-slate-700 mt-10 ml-[-65px] rounded-[30px] xl:ml-[-100px] xl:mt-[120px] xl:w-[480px] xl:h-[180px] xl:rounded-[50px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
...
<div className=" border-2 border-transparent w-[300px] h-[540px] xl:w-[650px] xl:h-[590px] mt-16 ml-[-65px] xl:ml-[-100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[725px]">
...
<div className=" border-2 border-transparent w-[300px] h-[1900px] xl:w-[650px] xl:h-[1730px] mt-40 ml-[-65px] xl:ml-[-100px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[2690px]">
...
<div className=" border-2 border-transparent w-[300px] h-[680px] xl:w-[650px] xl:h-[730px] mt-40 ml-[-65px] xl:ml-[-100px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[930px]">
...
<div className=" border-2 border-transparent w-[300px] h-[1530px] xl:w-[650px] xl:h-[1890px] mt-40 ml-[-65px] xl:mt-[300px] xl:ml-[-100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[2200px]">
