...
<div className=" ml-[-65px] border-2 border-transparent w-[270px] h-[50px] xl:w-[650px] xl:h-[100px] mt-[32px] xl:ml-[-300px] xl:mt-[100px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<h3 className=" md:text-[40px] text-[30px] mt-[80px] xl:text-[47px] text-left">Di cosa hai bisogno</h3>
</div>

<div className=" border-2 border-transparent w-[300px] h-[100px] xl:w-[650px] xl:h-[130px] mt-28 ml-[-65px] xl:ml-[-300px] xl:mt-[160px] min-[375px]:ml-[-50px]  md:w-[390px] md:ml-[-200px]">
<p className=" md:text-[27px] mt-[-8px] xl:text-[25px] text-left">Raspberry PI zero 2
    <br />
...
<div className=" ml-[-65px] border-2 border-transparent w-[270px] h-[50px] xl:w-[650px] xl:h-[100px] mt-[12px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<h3 className=" md:text-[40px] text-[30px] mt-[80px] xl:text-[47px] text-left">OS Lite</h3>
</div>

<div className=" border-2 border-transparent w-[300px] h-[200px] xl:w-[650px] xl:h-[200px] mt-28 ml-[-65px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[300px]">
<p className="  md:text-[27px] text-[20px] mt-[-8px] xl:text-[25px] text-left">Dopo aver installato l'OS Lite sulla micro SD, è necessario impostare il Raspberry con indirizzo IP statico e quello del gateway
che corrisponde all'indirizzo del modem, ciò ci permetterà di accedere dall'esterno;</p>
</div>

<div className=" border-2 border-transparent w-[300px] h-[120px] xl:w-[650px] xl:h-[130px] mt-5 ml-[-65px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[180px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> tali configurazioni, devono essere fatte nel file
...
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Scorrere lo script ed eliminare i commenti sulle righe che riguardano l'indirizzo IP statico:
<br />
<br />
...
<div className=" border-2 border-transparent w-[300px] h-[540px] xl:w-[650px] xl:h-[590px] mt-16 ml-[-65px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[725px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Fatto questo, salvate e riavviate il Raspberry con il comando:
<br />
<br />
...
<div className=" border-2 border-transparent w-[300px] h-[880px] xl:w-[660px] xl:h-[930px] mt-40 ml-[-65px] xl:ml-[300px] xl:mt-[200px] min-[375px]:ml-[-50px]  md:w-[390px] md:ml-[-200px] md:h-[1325px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Molto semplicemente per installare l'Apache, dare il comando seguente:
<br />
<br />
...
<div className=" border-2 border-transparent w-[300px] h-[550px] xl:w-[650px] xl:h-[600px] mt-40 ml-[-65px] xl:ml-[300px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:h-[780px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Per installare il PHP digitiamo il seguente comando:
<br />
<br />
...
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Salvare il tutto con "Ctrl + X", confermiamo con "Y" + "Invio".
</p>
</div>
...
<div className=" border-2 border-transparent w-[300px] h-[550px] xl:w-[650px] xl:h-[500px] mt-40 ml-[-65px] xl:ml-[300px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[720px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left  md:text-[27px]"> Ora possiamo verificare che tutto il lavoro fatto fino ad ora sia andato a buon fine. 
<br />
<br />
...
<div className=" ml-[-65px] border-2 border-transparent w-[270px] h-[50px] xl:w-[590px] xl:h-[100px] mt-[32px] xl:ml-[-300px] xl:mt-[300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<h3 className=" text-[30px] mt-[80px] xl:text-[47px] text-left md:text-[40px]">Installazione di MySQL</h3>
</div>

<div className=" border-2 border-transparent w-[300px] h-[1900px] xl:w-[650px] xl:h-[1730px] mt-40 ml-[-65px] xl:ml-[-300px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[2690px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> Eseguiamo il seguente comando:
<br />
<br />
...
<div className=" ml-[-65px] border-2 border-transparent w-[270px] h-[50px] xl:w-[620px] xl:h-[100px] mt-[32px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<h3 className=" text-[30px] mt-[80px] xl:text-[47px] text-left md:text-[40px]">Installazione di PHPMyAdmin</h3>
</div>

<div className=" border-2 border-transparent w-[300px] h-[680px] xl:w-[650px] xl:h-[730px] mt-40 ml-[-65px] xl:ml-[-300px] xl:mt-[200px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[930px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> 
...
<div className=" w-[300px] xl:w-[480px] h-[340px] ml-[-65px] mt-12 border-2 border-transparent xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<img src="mysqljpg.jpg" alt="" />
</div>

<div className=" border-2 border-transparent w-[300px] h-[130px] xl:w-[650px] xl:h-[130px] mt-28 ml-[-65px] xl:mt-[300px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[160px]">
<p className=" text-[20px] mt-[-8px] xl:text-[25px] text-left md:text-[27px]"> 
Inserire utente e password (root e Vosta Password) per poter accedere alla pagina di gestione del data base MySQL:
</p>
</div>

<div className=" w-[300px] h-[230px] xl:w-[480px] ml-[-65px] mt-12 border-2 border-transparent xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
<img src="Cattura 5.png" alt="" />
</div>

<div className=" border-2 border-transparent w-[300px] h-[1530px] xl:w-[650px] xl:h-[1890px] mt-40 ml-[-65px] xl:mt-[300px] xl:ml-[-300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[2200px]">
<p className=" text-[20px] mt-[-8px] xl:text-[32px] text-left md:text-[27px]"> 
...
<div className=" w-[300px] h-[130px] ml-[-65px] mt-12 border-2 border-transparent xl:ml-[-300px] xl:w-[480px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px]">
...
<div className=" border-2 border-transparent w-[300px] h-[350px] xl:w-[650px] xl:h-[500px] mt-40 ml-[-65px] xl:mt-[300px] xl:ml-[300px] min-[375px]:ml-[-50px] md:w-[390px] md:ml-[-200px] md:mt-[200px] md:h-[530px]">
<p className=" text-[20px] mt-[-8px] xl:text-[32px] text-left md:text-[27px]"> 
